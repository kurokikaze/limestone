/*jslint eqeqeq: true, immed: true, newcap: true, nomen: true, onevar: true, plusplus: true, regexp: true, undef: true, white: true, indent: 4 */
...
(function () {
    ...
    var chr, proto, encode;

    chr = String.fromCharCode;
    encode = { };

    // Factor out the encode so it can be shared by add_header and push_int32
    encode.encode_int32 = function (number) {
    ...
    encode.encode_int16 = function (number) {
        var a, b, unsigned;
    ...
    exports.Encoder = function (ServerCommand, ClientCommand) {
        ...
        this.header = encode.encode_int16(ServerCommand) + encode.encode_int16(ClientCommand);
        // } else {
        //    this.header = "";
        // }
        this.data = "";
    ...
    proto.toString = function (noCount) {
        ...
        var out_string = '';
        if (noCount) {
            out_string = this.header + encode.encode_int32(this.data.length) + this.data;
        } else {
            out_string = this.header + encode.encode_int32(this.data.length + 4) + encode.encode_int32(1) + this.data;
        }
    ...
    proto.push_int32 = function (number) {
        this.data += encode.encode_int32(number);
        return this;
    };
    ...
    proto.push_lstring = function (text) {
        this.data += encode.encode_int32(text.length) + text;
        return this;
    };
...
(function () {
    ...
    proto.shift_lstring = function () {
        var length, string;
        length = this.shift_int32();
        string = this.data.substr(0, length);
    ...
    proto.shift_multi_cstring = function () {
        var pos, string;
        pos = this.data.indexOf("\u0000\u0000");
        string = this.data.substr(0, pos).split("\u0000");
        this.data = this.data.substr(pos + 1);
        return string;
    };
